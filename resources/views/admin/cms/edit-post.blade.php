...
@section('body')
  <section class="container-fluid p-4">
    <header class="row">
      ...
      <div class="col-lg-12 col-md-12 col-12">
        <div class="border-bottom pb-4 mb-4 d-md-flex align-items-center justify-content-between">
          ...
          <div>
            <a href="{{route('cms.post')}}" class="btn btn-outline-secondary">Back to All Post</a>
          </div>
        </div>
      </div>
    </header>
    ...
    <div class="card border-0 mb-4">
      <!-- Card body -->
      <div class="card-body">
        <form method="post" action="{{route('cms.post.update', $post)}}" enctype="multipart/form-data">
          @csrf
          <div class="mb-4">
            ...
            <!-- input -->
            <input type="file" name="thumbnail" class="form-control dropify" data-default-file="{{$post->thumbnail}}">
          </div>
          ...
          <div class="row">
            <div class="mb-4 col-md-6">
              ...
              <input type="text" name="title" value="{{old('title') ?? $post->title}}" class="form-control text-dark"
            ...
            <div class="mb-4 col-md-6">
              ...
              <select class="selectpicker" name="category" data-width="100%">
                @foreach ($categories as $_)
                  <option value="{{$_->id}}" @selected($post->category == $_->id)>{{$_->name}}</option>
                @endforeach
              </select>
            </div>
          </div>
