...
<main>
  ...
  <section class="pt-lg-12 pb-lg-3 pt-8 pb-6">
    <div class="container">
      <div class="row mb-4">
        <div class="col">
          <h2 class="mb-0">Top Lawyers on Metalex</h2>
        </div>
      </div>
        ...
        <div class="sliderFirst">
          <div class="item">
            ...
            <div class="card mb-4 card-hover">
              <a href="pages/course-single.html" class="card-img-top"><img src="assets/images/course/course-react.jpg"
  ...
  <section class="pt-lg-12 pb-lg-3 pt-8 pb-6">
    <div class="container">
      <div class="row mb-4">
        <div class="col">
          <h2 class="mb-0">Top Law Firms on Metalex</h2>
        </div>
      </div>
      <div class="position-relative">
