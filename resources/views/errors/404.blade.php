    ...
    <section class="container d-flex flex-column">
      <div class="row">
        <div class="offset-xl-1 col-xl-2 col-lg-12 col-md-12 col-12">
          <div class="mt-4">
            <a href="{{url()->previous()}}">
              <img src="{{asset('assets/images/brand/logo/metalex_full_logo.svg')}}" alt=""
                   class="logo-inverse" style="height: 30px">
            </a>
            <!-- theme switch -->
      ...
      <div class="row align-items-center justify-content-center g-0 py-lg-22 py-10">
        ...
        <div class="offset-xl-1 col-xl-4 col-lg-6 col-md-12 col-12 text-center text-lg-start">
          ...
          <p class="mb-5 lead">Oops! Sorry, we couldn’t find the page you were looking for. If you think this is a
            problem with us, please <a href="#" class="btn-link">Contact us</a></p>
          <a href="{{url()->previous()}}" class="btn btn-primary me-2">Back to Safety</a>
        </div>
        <!-- img -->
        <div class="offset-xl-1 col-xl-6 col-lg-6 col-md-12 col-12 mt-8 mt-lg-0">
          <img src="{{asset('assets/images/error/404-error-img.svg')}}" alt="" class="w-100"/>
        </div>
      </div>
      <div class="row">
        <div class="offset-xl-1 col-xl-10 col-lg-12 col-md-12 col-12">
          <div class="row align-items-center mt-6">
            <div class="col-md-6 col-8">
              <p class="mb-0">&COPY; {{date('Y')}} Metalex Legal.</p>
            </div>
