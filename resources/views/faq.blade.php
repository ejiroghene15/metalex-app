      ...
      <div class="container">
        <div class="row">
          <div class="offset-md-2 col-md-8 col-12">
            <!-- caption-->
            <h1 class="fw-bold mb-1 display-5">Frequently Asked Questions</h1>
          </div>
        </div>
      </div>
    </section>
        ...
        <div class="row">
          <div class="offset-md-2 col-md-8 col-12">
            ...
            <div class="accordion accordion-flush" id="faqs">
              @foreach($faq as $_)
                <div class="border p-3 rounded-3 mb-2" id="heading_{{$loop->index}}">
                  <h3 class="mb-0 fs-4">
                    <a href="#" class="d-flex align-items-center text-inherit
                    text-decoration-none active"
                       data-bs-toggle="collapse" data-bs-target="#a_{{$loop->index}}"
                       aria-expanded="false" aria-controls="a_{{$loop->index}}">
                    <span class="me-auto">
                      {{$_['q']}}
                    </span>
                  ...
                  <div id="a_{{$loop->index}}" class="collapse"
