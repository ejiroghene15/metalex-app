<head>
  ...
  <!-- Favicon icon-->
  <link rel="shortcut icon" type="image/x-icon" href="{{ secure_asset('assets/images/favicon/metalex_ico.png') }}">

  @section('style')
  <!-- Libs CSS -->
  <link href="{{ secure_asset('assets/fonts/feather/feather.css') }}" rel="stylesheet">
  <link href="{{ secure_asset('assets/libs/bootstrap-icons/font/bootstrap-icons.css') }}" rel="stylesheet" />
  <link href="{{ secure_asset('assets/libs/@mdi/font/css/materialdesignicons.min.css') }}" rel="stylesheet" />
