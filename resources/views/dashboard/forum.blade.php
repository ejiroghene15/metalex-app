          ...
          <div class="card mb-4">
            ...
            <div class="card-header d-lg-flex align-items-center justify-content-between">
              <div class="mb-3 mb-lg-0">
                ...
                <span>
                  You have full control to create manage your own forum
                </span>
              </div>
              <div>
                ...
                <li class="list-group-item @if(!$loop->first)py-3 @else pt-0 @endif">
                  <div class="d-flex justify-content-between">
                    <div class="d-flex align-items-start">
                      <img src="{{ asset('assets/images/avatar/conversation.png') }}" class="me-2" height="28" width="28" alt="">
                      <a href="{{ route('forum.topics', ['slug' => $_->slug, 'id' => $_->id]) }}" class="text-muted">
                    ...
                    <div>
                      <span class="dropdown dropstart">
                        ...
                        <span class="dropdown-menu" aria-labelledby="forumSetting">
                          ...
                          <a class="dropdown-item" href="#"><i class="fe fe-trash dropdown-item-icon"></i>
                            Remove
                          </a>
                          <a class="dropdown-item" href="#">
