<form method="POST" class="row registration_form">
  ...
  <!-- Firm Name -->
  <div class="mb-3">
    <label for="firm_name" class="form-label"><span class="text-danger fw-bold">*</span> Name of Firm</label>
    <input type="text" class="form-control" name="firm_name" placeholder="John & Jane Doe" required>
  </div>
  ...
  {{-- zip code --}}
  <div class="mb-3 col-12 col-md-4">
    <label class="form-label" for="zipCode"><span class="text-danger fw-bold">*</span> Zip/Postal Code</label>
